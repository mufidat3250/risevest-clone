      ...
      <section className="pt-[10rem] bg-[#f6f2fe]">
        <div className=" flex flex-col justify-center items-center bg-white">
          ...
          <ProductList
            title="Real Estate
"
            disc="We invest in our portfolio of rented buildings in the US and manage your money for returns through rent and capital appreciation."
            riskLevel="Medium"
            historyPercent="14"
          />
        </div>
        ...
        <div className="bg-white pt-[6rem]">
          <div className="container bg-white">
            <ChooseRise
              data={gridData}
              title="Why Choose Rise For Real Estate Investment"
            />
          </div>
        </div>
      </section>
